...
const Sidebar: FC = ({}) => {
  ...
  return (
    <div className="">
      ...
      <div
        className={` h-screen   fixed  py-8 px-6 top-0  duration-700  transition-all left-0 z-40  lg:w-[12.5%] bg-white dark:bg-black  ${
            ...
            {sidebarNavItems.map((item, index) => (
              <div key={index} className="cursor-pointer">
                <Link href={item.to} className="cursor-pointer">
                  <div
                    className={` group flex items-center content-start mb-3 py-2   transition duration-400 ease-in-out item ${
